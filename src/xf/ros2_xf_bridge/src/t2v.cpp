...
void voiceWordsCallback(const std_msgs::msg::String::SharedPtr msg)
{
    ...
    popen("play tts_sample.wav", "r"); //可以直接播放语音文件
    sleep(1);
}
...
int main(int argc, char *argv[])
{
    ...
    // 创建一个订阅者
    auto wakeUpSub = node->create_subscription<std_msgs::msg::String>("ttswords", 10, std::bind(&voiceWordsCallback, _1));//voiceWordsCallback
    rclcpp::spin(node);
