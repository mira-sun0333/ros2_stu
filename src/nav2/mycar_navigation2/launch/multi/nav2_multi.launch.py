...
def generate_launch_description():
    ...
    bt_yaml = os.path.join(current_pkg,"params",car_num,"bt.yaml")
    planner_yaml = os.path.join(current_pkg,"params",car_num,"planner.yaml")
    controller_yaml = os.path.join(current_pkg,"params",car_num,"controller.yaml")
    behavior_yaml = os.path.join(current_pkg,"params",car_num,"behavior.yaml")
    waypoint_yaml = os.path.join(current_pkg,"params",car_num,"waypoint.yaml")
    smoother_yaml = os.path.join(current_pkg,"params",car_num,"smoother.yaml")
    velocity_yaml = os.path.join(current_pkg,"params",car_num,"velocity.yaml")
    ...
    group = GroupAction(
        actions=[
            ...
            Node(
                ...
                # 发布smooth_cmd_vel话题
                remappings=[
                    ("cmd_vel", "cmd_vel_nav"), # 订阅控制器的速度
                    ("cmd_vel_smoothed", "cmd_vel") # 发布机器人可以识别的速度话题
                ]
            ),
